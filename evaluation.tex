...
\section{Performance}
{
    ...
    {
        Figure \ref{fig:compiler-perf} presents the minimum time taken to compile each benchmark program: \compilername is faster than both Eta and Frege to compile all benchmarks except for \monospace{mergesort}. 
