...
\section{Performance}
{
    ...
    \subsection{Execution Speed}
    {
        ...
        \todo[inline]{Might need to switch some of the plots to use a logarithmic y axis...}
        ...
        program's execution is spent in the functions associated with creating and calling closures: \monospace{enter},
        \monospace{addArgument}, and \monospace{clone}. A more efficient implementation should have most of the runtime
        spent in one or more of the \monospace{Impl} functions (such as \monospace{_v19Impl}), which perform the actual
        ...
        with objects of the class storing \java{Function} objects generated using the \monospace{invokedynamic}
        ...
        \todo[inline]{The above hopefully conveys `I chose a different approach because I wanted to experiment, it's less efficient but I had fun anyway and have a decent idea as to why it's less efficient'.}
    ...
    \subsection{Executable Size}
    {
        ...
        \todo[inline]{Data for Eta here is outdated for all but \monospace{factorial}, it's quite a bit smaller but still larger than Frege and mine.}
    ...
    \subsection{Impact of Optimisations}
    {
        ...
        \todo[inline]{Yeah this doesn't look good: check this is correct + work out why?}
