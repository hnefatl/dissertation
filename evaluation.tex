...
\section{Performance}
{
    ...
    \subsection{Impact of Optimisations}
    {
        ...
        \begin{figure}[H]
            ...
            \caption{Runtime of the benchmarks after compilation with various optimisations: L stands for let-lifting, D for binding deduplication, and U for unreachable code elimination.}
            \label{fig:opt-perf}
        \end{figure}
