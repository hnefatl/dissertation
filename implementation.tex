...
\section{Implementation Details}
{
    ...
    \subsection{Type Checker}
    {
        ...
        \subsubsection*{Deoverloader}
        {
            ...
            dEqBoolEq True True = True
            dEqBoolEq False False = True
            dEqBoolEq _ _ = False
            dEqBoolNeq x y = not (dEqBoolEq x y)
            \end{haskellfigure}
    ...
    \subsection{Lowering and Intermediate Languages}
    {
        ...
        \subsubsection*{Intermediate Language A}
        {
            ...
            features like GADTs, as they are not supported by this compiler. Below is the full definition of ILA:
