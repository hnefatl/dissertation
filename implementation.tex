...
\section{Implementation Details}
{
    ...
    \subsection{Lowering and Intermediate Languages}
    {
        ...
        \subsubsection{Intermediate Language A}
        {
            ...
            \todo[inline]{Case statements on literals are converted into equality checks, as they don't fit the normal approaches. However, this is only implemented in the pattern match code, not the general case statement code...}
