...
\section{Type Checker}
{
    ...
    \subsection{Definition of Types}
    {
        ...
        During type inference, types are almost always polymorphic and often overloaded (\haskell{(==) :: forall a. Eq a => a -> a -> Bool}, \haskell{head :: forall a. [a] -> a}, ...). After deoverloading (Section \ref{sec:deoverloading}), types are never overloaded. This difference is enforced in the compiler by using \haskell{QuantifiedType} and \haskell{QuantifiedSimpleType} respectively.
    }
