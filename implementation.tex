...
\section{Implementation Details}
{
    ...
    \subsection{Type Checker}
    {
        ...
        \subsubsection{Type Inference}
        {
            ...
            One departure from the HM algorithm is that Haskell restricts polymorphism for some terms: let-bound
            variables are polymorphic over all their free type variables, while function parameters are never
            polymorphic. In practice, this means that in the code below, \haskell{f :: #\(\forall \alpha.\;\alpha
