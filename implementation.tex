...
\section{Preprocessor}
{
    ...
    \subsection{Dependency Analysis}\label{sec:dependency-analysis}
    {
        ...
        The strongly connected components (SCCs) of the dependency graph correspond to sets of mutually recursive declarations, and the partial order between components gives us the order to typecheck each set. I use an existing Haskell library to compute the SCCs (\texttt{containers}), which uses the algorithm presented by M. Sharir\cite{SCC}.
        ...
        \caption
        {
            Code labelled with declaration numbers, and the corresponding dependency graph. Variables are in blue, type constants in red. Strongly connected components are grouped.
        }
...
\section{Code Generation}
{
    ...
    \subsection{Heap Objects}\label{sec:heap-objects}
    {
        ...
        \subsubsection{Literals}\label{sec:literals}
        {
            ...
            The implementation of the \haskell{Integer} literal type using this class is given in Appendix \ref{appendix:integer-literal}.
...
{
    The main code repository for this project is available at \url{https://github.com/hnefatl/dissertation-project} -- all of the code in this repository was written from scratch.
