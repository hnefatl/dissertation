...
\section{Type Checker}
{
    ...
    \todo[inline]{Explanation of kinds got transplanted to the preparation: add a reference}
    ...
    \subsection{Type Inference}
    {
        ...
        \item
        {
            ...
            signatures). This feature was omitted in order to spend development time on the later stages of the
            compiler.
...
\section{Code Generation}
{
    ...
    \subsection{Heap Objects}\label{sec:heap-objects}
    {
        ...
        The abstract \java{enter} method evaluates the object to WHNF (described in Section \ref{sec:whnf}) and returns
        a reference to the result, and the \java{clone} method simply returns a shallow copy of the object. This method
