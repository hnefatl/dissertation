...
\section{Implementation Details}
{
    ...
    \subsection{Optimisations}
    {
        ...
        native machine code\todo{citation}. The Jikes JVM, as of
        ...
        \subsubsection{Code generation}
        {
            ...
            \todo[inline]{Not planning to write yet: would like to sneakily implement unused code elimination in the tons of time I have available and write that up instead, as a `proper optimisation technique'.}
