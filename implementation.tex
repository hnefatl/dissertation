...
\section{Implementation Details}
{
    ...
    \subsection{Lowering and Intermediate Languages}
    {
        ...
        \subsubsection{Intermediate Language A}
        {
            ...
            \haskell{y = 1}, and \haskell{z = [2]}. Multiple pattern matches can also be matched in parallel, as in
            ...
            % TODO(kc506): This really needs more separation. This should be sectioned under "Pattern matching
            ...
            but didn't support multiple parallel patterns as used in \haskell{case} expressions and function definitions
            such as in \haskell{f} above.
            
            An idealised declarative version of the implementation is presented below as a function operating on terms
            of ILA. It demonstrates the translation of a few of the possible patterns. Syntactic terms of ILA are
            presented in monospaced font and meta-variables used to represent ILA terms are given in script font:
            ...
            patterns to match the variables against, and \(b\) is a Haskell expression for the right-hand-side of the
            pattern match. For example, the expression \haskell{case x of { y@(Just z) -> (y, z) }} would be translated
            as:
            ...
            The current implementation is now based off the approach given in Chapter 5 of
            `The Implementation of Functional Programming Languages' \cite{ImplFunLang}, which is a generalisation of my
            approach: a stack of variables to match against are processed along with a list of `rows', each of which
            contains a stack of patterns and a right-hand-side expression.

            \todo[inline]{Is this enough of an explanation of the difference?}
