...
\section{Related Work}
{
    ...
    Eta is a dialect of Haskell emphasising foreign-function interoperability with Java. The \monospace{eta} compiler is a fork of GHC, replacing the code generation stage with one producing JVB.
