...
\todo[inline]{Would be nice to include benefits of using my tool over an alternative, but realistically there aren't any: mine supports a smaller subset of Haskell, doesn't provide Java interop, and is slower than the others. The one plus is compilation speed, which isn't really enough to bring up.}
