...
Word Count:         & \textbf{\input{|"./wordcount.sh"}}\footnotemark[1] \\
Lines of Code:      & \textbf{\input{|"./codecount.sh"}}\footnotemark[2] \\
...
\footnotetext[1]{Calculated using \monospace{texcount -1 -sum}}
\footnotetext[2]{Calculated using \monospace{wc -l}}
